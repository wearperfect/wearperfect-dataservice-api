...
import com.wearperfect.dataservice.api.dto.ProductStyleBasicDetailsDTO;
...
public interface ProductStyleMapper {
    ...
    ProductStyleBasicDetailsDTO mapProductStyleToProductStyleBasicDetailsDto(ProductStyle productStyle);
