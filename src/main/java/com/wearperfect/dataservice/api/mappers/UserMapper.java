...
@Mapper(uses = {User.class, UtilityMapper.class, RoleMapper.class, GenderMapper.class, AddressMapper.class}, unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface UserMapper {
	...
	@Mapping(source = "businessAddressDetails", target = "businessAddress")
	@Mapping(source = "createdOn", target = "createdOn", qualifiedByName = "dateToTimeConverter")
	@Mapping(source = "lastUpdatedOn", target = "lastUpdatedOn", qualifiedByName = "dateToTimeConverter")
